...
class ProductDAO:
    def __init__(self):
        ...
        self.products = [
            ...
            Product(3, "Speedmaster Date", "Omega", 1495, "Sport", 'Automatic', 'Steel', 'Steel', 'Fold clasp', 'Steel', '39 x 13.5 mm', 'Steel', '5 ATM', 'Steel', 'Sapphire crystal', 'change', '44 h', 'Omega_Speedmaster.jpg', "This Omega Speedmaster Date 3513.50.00 has a black baton dial and a bracelet strap. This Omega has undergone a thorough inspection of accuracy, functionality and condition at our Omega certified service centre to determine the level of reconditioning required to meet our strict standards. It has also been checked against our records to ensure authenticity. All our watches have a 24-month warranty for your peace of mind." ),
            Product(4, "Datejust 36", "Rolex", 4950, "Luxury", 'Automatic', 'Gold/Steel', 'Gold/Steel', 'Fold clasp', 'Steel','36 mm', 'Gold/Steel', '10 ATM', 'Yellow Gold', 'Plexiglass', 'change', '42 h', 'Rolex_Datejust36.webp',
            ...
            Product(5, "Daytona", "Rolex", 41150, "Luxury", 'Automatic', 'Rose Gold', 'Gold', 'Fold clasp', 'Rose Gold', '40 mm', 'Rose Gold', '10 ATM', 'Rose Gold', 'Sapphire crystal', 'change', '72h','Rolex_Dytona.webp',
            ...
            Product(6, "Submariner Date", "Rolex", 12000, "Luxury", 'Automatic', 'Yellow Gold', 'Gold', 'Fold clasp',
                    'Gold', '40 mm', 'Yellow Gold', '5 ATM', 'Yellow Gold', 'Sapphire crystal', 'change', '55 h', 'Rolex_SM_Date.webp',
            ...
            Product(7, "Perpetual Calendar", "Patek Philippe", 26000, "Luxury", 'Automatic', 'Leather', 'Black', 'Fold clasp', 'White Gold',
                    '37 mm', 'White Gold', '5 ATM', 'White gold', 'Sapphire crystal', 'change', '40 h', 'PP_PC.webp',
