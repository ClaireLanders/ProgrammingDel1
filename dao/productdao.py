...
class ProductDAO:
    def __init__(self):
        ...
        self.products = [
            ...
            Product(4, "Datejust 36", "Rolex", 4950, "Luxury", 'Automatic', 'Gold/Steel', 'Gold/Steel', 'Fold clasp', 'Steel','36 mm', 'Gold/Steel', '10 ATM', 'Yellow Gold', 'Plexiglass', 'Gold', '42 h', 'Rolex_Datejust36.webp',
            ...
            Product(5, "Daytona", "Rolex", 41150, "Luxury", 'Automatic', 'Rose Gold', 'Gold', 'Fold clasp', 'Rose Gold', '40 mm', 'Rose Gold', '10 ATM', 'Rose Gold', 'Sapphire crystal', 'Rose Gold', '72h','Rolex_Dytona.webp',
            ...
            Product(6, "Submariner Date", "Rolex", 12000, "Luxury", 'Automatic', 'Yellow Gold', 'Gold', 'Fold clasp',
                    'Gold', '40 mm', 'Yellow Gold', '5 ATM', 'Yellow Gold', 'Sapphire crystal', 'Gold', '55 h', 'Rolex_SM_Date.webp',
                    "This Rolex Submariner 16610 has a black dial and a bracelet strap. This Rolex has undergone a thorough inspection of water resistance, accuracy, functionality and condition to determine the level of reconditioning required to meet our strict standards. It has also been referenced against technical documents and manufacturer records where available to ensure authenticity and a clean history. "),
            Product(7, "Perpetual Calendar", "Patek Philippe", 26000, "Luxury", 'Automatic', 'Leather', 'Black', 'Fold clasp', 'White Gold',
                    '37 mm', 'White Gold', '5 ATM', 'White gold', 'Sapphire crystal', 'White Gold', '40 h', 'PP_PC.webp',
            ...
            Product(8, "Calatrava", "Patek Philippe", 5000, "Luxury", 'Manual winding', 'Leather', 'Black',
                    'Fold clasp', 'Gold',
                    '33 mm', 'Gold', '5 ATM', 'Gold', 'Sapphire crystal', 'Black', '35 h', "PP_Calatrava.webp","Supremely elegant, the Calatrava charms each new genereation of watch lovers by its timeless understated perfection."
                )
        ]
